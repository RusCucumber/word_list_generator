...
words = []
for i in range(len(words_given)):
    words.append(words_given[i][0] + "," + words_given[i][1] + "\n")
...
class Quizlet:
    ...
    def __init__(self, words, browser):
        self.words = words
